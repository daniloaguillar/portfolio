      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            <a
              href="https://www.linkedin.com/in/danilo-aguillar-0718a4145/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-offwhite/30 hover:text-accent transition-colors"
              aria-label="LinkedIn"
            >
            ...
            <a
              href="https://www.instagram.com/danilosurreal/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-offwhite/30 hover:text-accent transition-colors"
