...
function ProjectCard({
  ...
  return (
    <motion.div
      ...
      className={`group cursor-none rounded-xl bg-[#F5F5F0] shadow-[0_4px_24px_rgba(0,0,0,0.10)] ${
    ...
    >
      {project.image ? (
        <>
          ...
          {/* Caption */}
          <div className="mt-1 bg-[#F5F5F0] border-x border-b border-accent rounded-b-xl px-5 py-4 pb-5">
