export const siteProjects = [
  ...
  {
    id: 12,
    key: "stripoli" as const,
    name: "Strípoli NR1",
    type: { pt: "Landing Page", en: "Landing Page", es: "Landing Page" },
    year: 2026,
    url: "https://nr1.clinicastripoli.com.br/",
    featured: false,
    image: "/stripoli.webp",
    imageMobile: "/stripoli-mobile.webp",
    siteImage: "/stripoli-full.webp",
    siteImageMobile: "/stripoli-full-mobile.webp",
    tags: ["Landing Page", "Design sensorial", "Conversão"],
  },
  {
    id: 2,
    key: "rm" as const,
